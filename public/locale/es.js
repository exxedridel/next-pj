export default {
  ...
  home: {
    ...
    brandSEO: {
      ...
      p2: "Tu Web App se registra en el índice de Google para que tu marca pueda ser encontrada facilmente por tu público objetivo, basta con una búsqueda en la web.",
    },
    ...
    advantage: {
      ...
      description3:
        "Puedes confiar en que tu producto estará disponible para tus clientes 24/7 ya que hacemos todas las reparaciones, actualizaciones y mejoras que tu Web App pueda necesitar para funcionar adecuadamente con el tiempo.",
    },
  ...
  services: {
    calculator: {
      ...
      startBtn: "Empecemos",
      instructions: "Selecciona las caracteristicas que tu Web App necesita:",
      feature1: {
